...
4. When a **Bullet** collides with an **[Enemy](Enemy.md)**, the **[Enemy](Enemy.md)** must be destroyed, the **Bullet** must be removed, and an **[Explosion](Explosion.md)** must be displayed at the **[Enemy](Enemy.md)**'s position for 1 second.
